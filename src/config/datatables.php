...
return [
    ...
    */
    ...
    'boolean' => [
        false => '<span class="tag is-boolean is-danger"><span class="icon is-small"><i class="fa fa-times"></i></span></span>',
        true => '<span class="tag is-boolean is-success"><span class="icon is-smalls"><i class="fa fa-check"></i></span></span>',
    ],

    /*
    |--------------------------------------------------------------------------
    | Excel Export Row Limit
    |--------------------------------------------------------------------------
    |
    | Yahooo
    |
