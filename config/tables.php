...
return [
    ...
    */
    ...
    'comparisonOperator' => ComparisonOperator::Like->value,
    ...
    */
    ...
    'searchModes' => [
        SearchMode::Full->value, SearchMode::StartsWith->value, SearchMode::EndsWith->value,
        SearchMode::ExactMatch->value, SearchMode::DoesntContain->value,
        // SearchMode::Algolia->value,
    ],
